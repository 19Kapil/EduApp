...
type Props = NativeStackScreenProps<RootStackParamList, "ParentsRoutineScreen">;

const ParentsRoutineScreen: React.FC<Props> = ({ navigation }) => {
...
export default ParentsRoutineScreen;
