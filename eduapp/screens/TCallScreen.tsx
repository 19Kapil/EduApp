...
type Props = {
  ...
  route: RouteProp<RootStackParamList, "CallScreen"> & {
    params: { parent: { name: string; avatar: ImageSourcePropType } };
  };
};

const TCallScreen: React.FC<Props> = ({ navigation, route }) => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.avatarContainer}>
        <Image source={parent.avatar} style={styles.avatar} />
